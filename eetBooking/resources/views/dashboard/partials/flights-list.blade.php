@foreach($flightBookings as $booking)
  <div class="p-4 rounded-xl border border-gray-100 hover:border-purple-100 transition hover:shadow-md bg-white group">
    <div class="flex items-center justify-between mb-2">
      <span class="text-xs font-bold text-gray-400">FLIGHT • {{ $booking->booking_reference }}</span>
      @php
        $statusColors = [
    ...
    <div class="flex items-center gap-4">
      <div class="flex-1">
        <div class="text-lg font-bold text-gray-900 flex items-center gap-2">
          ...
          <i class="fa-solid fa-plane text-gray-300 text-sm transform rotate-45"></i>
        ...
        <div class="text-sm text-gray-500 mt-1 flex items-center gap-4">
          <span class="flex items-center gap-1"><i class="fa-regular fa-calendar"></i>
            {{ $booking->departure_date->format('M d, Y') }}</span>
